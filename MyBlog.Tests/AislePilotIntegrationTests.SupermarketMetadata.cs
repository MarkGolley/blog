...
public partial class AislePilotIntegrationTests
{
    ...
    [Fact]
    public async Task Index_Post_RendersStructuredSupermarketInsightStripSeparateFromSnapshotGrid()
    {
        using var client = CreateClient(allowAutoRedirect: true);
        var antiForgeryToken = await GetAntiForgeryTokenAsync(client, "/projects/aisle-pilot");
        ...
        Assert.Contains("data-supermarket-card", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("data-overview-primary-grid", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("data-overview-support-grid", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("data-supermarket-insight-strip", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("Supermarket research", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("data-supermarket-insight-panel=\"layout\"", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("data-supermarket-insight-panel=\"pricing\"", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("Layout source", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("Pricing source", html, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("data-supermarket-insight-warning", html, StringComparison.OrdinalIgnoreCase);
    }
}
